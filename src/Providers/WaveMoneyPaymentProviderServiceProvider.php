...
class WaveMoneyPaymentProviderServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__ . '/../../database/migrations/create_wave_money_payment_provider_tables.php.stub'
        ...
        return Collection::make($this->app->databasePath() . DIRECTORY_SEPARATOR . 'migrations' . DIRECTORY_SEPARATOR)
            ->flatMap(function ($path) use ($filesystem) {
                if (count($filesystem->glob($path . '*_create_wave_money_payment_provider_tables.php'))) {
                    ...
                    file_put_contents($file, file_get_contents(__DIR__ . '/../../database/migrations/create_wave_money_payment_provider_tables.php.stub'));
                }
